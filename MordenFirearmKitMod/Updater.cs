...
//        //Mod名字
//        public static string ModName = /*Assembly.GetExecutingAssembly().GetName().Name*/null;
...
//        //当前Mod版本号
//        private static  Version CurrentVersion = /*Assembly.GetExecutingAssembly().GetName().Version*/null;

//        //提示窗口大小
//        private Rect windowDialog = new Rect(300, 300, 320, 150);

//        //提示窗口ID
//        private int windowID = /*Util.GetWindowID()*/0;
...
//            var release = JsonUtility.ToJson(value);
